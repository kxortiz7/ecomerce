...
const Navbar = () => {
  return (
    <div className=''>
      ...
      <div className="content-nabvar">
      <nav className="navbar navbar-expand-lg navbar-light bg-light pb-0" id='contect-nabvar-1'>
        <div className='container-fluid-two-l '>
          <NavLink to="/home">
            <img src={imgdog} alt="" /></NavLink>
        </div>
        <div className="flex-item ms-auto mx-5 p-0" id='col-xs-4' >
          ...
          <div className="container-fliud-promo p-0">
      ...
      <nav className="navbar navbar-expand-lg navbar-light bg-light mx-5 p-0 " id='nav-cl-two' >
        <div className="container-fluid p-0 ">
          ...
          <div className='car-shop'>
            <i className="bi bi-cart3 fa-lg" ></i>
            <h6>CARRITO</h6>
          </div>
        </div>
      </nav>
